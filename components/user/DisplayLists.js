  ...
  return (
    <>
      {isLoadingQuery ? (
        ...
        <div className="">
              <h2 className="text-3xl font-bold mb-10 border-b pb-2 border-main-color/20 text-main-color tracking-tight">
          ...
          {resultbookListQuery.length ? (
            resultbookListQuery?.map((docData) => {
              return (
                ...
                <div key={docData.id} className="p-10 border-b-2 border-t border-r-2 border-l-2 relative border-l-slate-100 border-r-slate-100 border-t-slate-100 border-slate-200/90 my-10 shadow-xl rounded-xl">
                  <div className="flex flex-row gap-2">
                    <Link href={`/list/${docData?.slug}`}>
               
                      <h2
                        className="text-3xl font-bold tracking-tight my-2 text-purple-800 flex"
                    ...
                    <p>
                      {!docData.private ? (
                        <div className="pb-3 pt-2 px-3 md:px-5 mt-2 font-bold text-sm text-white border bg-purple-800 block tracking-tight right-0 absolute shadow-sm">
                          publique
                        </div>
                      ) : (
                        <div className="pb-3 pt-2 px-3 md:px-5 mt-2 font-bold text-sm text-white border bg-red-800 block tracking-tight right-0 absolute shadow-sm">
                          privée
                        </div>
                      )}
                    </p>
