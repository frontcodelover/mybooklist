...
>
  ...
  <div
    className="absolute  bg-white/75 sm:bg-transparent sm:bg-gradient-to-r sm:from-white/95 sm:to-white/25"
  ></div>
  ...
  >
    <div className="max-w-xl text-center sm:text-left">
      ...
      <p className="mt-4 max-w-lg sm:text-xl sm:leading-relaxed text-white/80">
