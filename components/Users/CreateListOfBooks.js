  ...
  return (
    <>
      <div className='flex flex-col bg-gray-100 p-5 rounded-xl shadow'>
        <h2 className='text-3xl font-bold mb-3 text-main-color'>Créer une liste</h2>
        <form onSubmit={handleCreateList}>
          <input type='text' name='name' placeholder='Nom de la liste de lecture' className='w-full p-2 mb-4 border border-gray-300 rounded-md' onChange={handleChange} required />
          <textarea
            type='textarea'
            name='description'
          ...
          <div className='my-2'>
            ...
            <br />
            <input type='checkbox' name='private' onChange={handleChange} value='true' id='private' className='mr-2 my-2' />
          </div>
          <br />
          <button type='submit' className='w-full p-2 my-5 bg-purple-500 text-white rounded-md shadow font-semibold max-w-fit'>
