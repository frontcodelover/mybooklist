            ...
            <div className="bg-white flex items-center justify-center mx-4 md:w-2/3 ">
                <div className="flex flex-col items-center py-16 ">
                  <Image src={error} width={500} height={500} />
                    ...
                    <p className="px-4 pb-10 text-base leading-none text-center text-gray-600">La page que vous souhaitez consulter n'existe pas ! </p>
                    <Link href="/">
<a>

                    <button className="mx-4 h-10 w-44 border rounded-md text-white text-base bg-indigo-700 hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-opacity-50 focus:ring-indigo-800">Retourner à l'accueil</button>
</a>
                    </Link>
                </div>
            </div>
